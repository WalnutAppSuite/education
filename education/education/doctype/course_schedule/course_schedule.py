...
class CourseSchedule(Document):
    ...
    def set_hex_color(self):
        """Assign a hex color code to the schedule"""
        colors = {
            "blue": "#EDF6FD",
            "green": "#E4F5E9",
            "red": "#FFF0F0",
    ...
    def validate_day_and_period(self):
        """Validates that the combination of day and period_no is unique."""
        if self.day and self.period_no:
            ...
            if existing_schedule:
                frappe.throw(
                    _(
                        f"The combination of Day '{self.day}' and Period No '{self.period_no}' already exists for the Student Group {self.student_group}."
                    )
                )
